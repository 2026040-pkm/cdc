...
tasks.withType<Test> {
    ...
    systemProperty("cdc.verify.source.url",
        System.getProperty("cdc.verify.source.url", "jdbc:postgresql://localhost:60432/sourcedb"))
    systemProperty("cdc.verify.target.url",
        System.getProperty("cdc.verify.target.url", "jdbc:postgresql://localhost:60433/targetdb"))
