...
# 운영 테이블(car, computer)과 embedded_cdc_tsdb_slot 은 건드리지 않는다.
#
...
target_url="${CDC_VERIFY_TARGET_URL:-jdbc:postgresql://localhost:60433/targetdb}"
...
for c in tsdb-lidar-pg emb-cdc-tsdb-target-pg emb-cdc-tsdb-service; do
