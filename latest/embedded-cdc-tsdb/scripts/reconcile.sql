...
--
--   docker exec -i emb-cdc-tsdb-source-pg psql -U postgres -d sourcedb -f - < scripts/reconcile.sql
--   docker exec -i emb-cdc-tsdb-target-pg psql -U postgres -d targetdb -f - < scripts/reconcile.sql
--
-- ── 왜 구간을 따로 내는가 ────────────────────────────────────────────────────
